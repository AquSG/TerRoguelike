...
{
    public class TrumpCard : BaseRoguelikeItem, ILocalizedModType
    {
        public override int modItemID => ModContent.ItemType<TrumpCard>();
        ...
        {
            player.GetModPlayer<TerRoguelikePlayer>().trumpCard += Item.stack;
        }
    }
}
