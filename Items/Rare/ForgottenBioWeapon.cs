...
{
    public class ForgottenBioWeapon : BaseRoguelikeItem, ILocalizedModType
    {
        public override int modItemID => ModContent.ItemType<ForgottenBioWeapon>();
        ...
        {
            player.GetModPlayer<TerRoguelikePlayer>().forgottenBioWeapon += Item.stack;
        }
    }
}
