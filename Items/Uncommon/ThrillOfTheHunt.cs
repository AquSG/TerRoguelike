...
{
    public class ThrillOfTheHunt: BaseRoguelikeItem, ILocalizedModType
    {
        public override int modItemID => ModContent.ItemType<ThrillOfTheHunt>();
        ...
        {
            player.GetModPlayer<TerRoguelikePlayer>().thrillOfTheHunt += Item.stack;
        }
    }
}
