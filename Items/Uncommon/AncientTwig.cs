...
{
    public class AncientTwig : BaseRoguelikeItem, ILocalizedModType
    {
        public override int modItemID => ModContent.ItemType<AncientTwig>();
        ...
        {
            player.GetModPlayer<TerRoguelikePlayer>().ancientTwig += Item.stack;
        }
    }
}
