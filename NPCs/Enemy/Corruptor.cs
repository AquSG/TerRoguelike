    ...
    public class Corruptor : BaseRoguelikeNPC
    {
        ...
        public override void AI()
        {
            ...
            if (NPC.ai[0] > 0 && NPC.ai[0] <= attackTelegraph && NPC.ai[1] % 2 == 0)
            {
                ...
                Dust dust = Dust.NewDustPerfect(NPC.Center + offset + NPC.rotation.ToRotationVector2() * 10, modNPC.hostileTurnedAlly ? DustID.CoralTorch : DustID.GreenTorch, -offset * 0.01f + NPC.velocity, 0, Color.LimeGreen, 1.4f);
                dust.noGravity = true;
