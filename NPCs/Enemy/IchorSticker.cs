...
namespace TerRoguelike.NPCs.Enemy
{
    public class IchorSticker : BaseRoguelikeNPC
    {
        ...
        public override void AI()
        {
            ...
            modNPC.RogueFlyingShooterAI(NPC, 0.6f, 0.6f, 0.02f, 160f, 480f, attackTelegraph, attackCooldown, ModContent.ProjectileType<IchorBlob>(), 8f, new Vector2(0, 10).RotatedBy(NPC.rotation), NPC.damage, true, 0.98f);
