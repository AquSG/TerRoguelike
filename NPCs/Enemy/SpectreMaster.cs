...
namespace TerRoguelike.NPCs.Enemy
{
    public class SpectreMaster : BaseRoguelikeNPC
    {
        ...
        {
            modNPC.RogueTeleportingShooterAI(NPC, 96f, 240f, 360, attackTelegraph, attackCooldown, ModContent.ProjectileType<Spectre>(), 1f, Main.rand.NextVector2CircularEdge(48f, 48f), NPC.damage, true, true);
