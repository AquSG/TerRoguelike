...
{
    public class FleshVomit : ModProjectile, ILocalizedModType
    {
        ...
        public override void AI()
        {
            ...
            {
                int d = Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.CrimsonPlants, 0, 0, Projectile.alpha, default(Color), 1.2f);
            ...
            Color color = Color.Lerp(Color.Lerp(Color.Red, Color.Yellow, Main.rand.NextFloat(0.3f)), Color.Black, 0.2f);
        ...
        public override void OnKill(int timeLeft)
        {
            for (int i = 0; i < 4; i++)
            {
                int d = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.CrimsonPlants, Main.rand.NextFloat(-2f, 2f), Main.rand.NextFloat(-2f, 2f), Projectile.alpha, default(Color), 1.2f);
                Dust dust = Main.dust[d];
                dust.noLightEmittence = true;
                dust.noLight = true;
                if (Main.rand.NextBool())
