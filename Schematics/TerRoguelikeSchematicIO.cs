...
namespace TerRoguelike.Schematics
{
    ...
    public struct SchematicMetaTile
    {
        ...
        public void ApplyTo(int x, int y, SchematicMetaTile original)
        {
            ...
            if (!keepTile && !keepWall) // full overwrite
            {
                ...
                TerRoguelikeSchematicIO.AssignWallWireState(ref targetWallWireState, wallWireState.NonFrameBits);
            ...
            else if (keepTile && keepWall) // full preservation
            {
                ...
                ref var targetWallWireState = ref (Main.tile[x, y].Get<TileWallWireStateData>());
                TerRoguelikeSchematicIO.AssignWallWireState(ref targetWallWireState, original.wallWireState.NonFrameBits);
    ...
    public static class TerRoguelikeSchematicIO
    {
        ...
        public static SchematicMetaTile[,] LoadSchematic(string filename)
        {
            ...
            using (Stream st = TerRoguelike.Instance.GetFileStream(filename, true))
            {
        ...
        private static SchematicMetaTile[,] ImportSchematic(Stream fileInputStream)
        {
            ...
            {
                TerRoguelike.Instance.Logger.Error(TML13ValidString);
