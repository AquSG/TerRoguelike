...
namespace TerRoguelike.Schematics
{
    public static class SchematicManager
    {
        ...
        public static void LoadRoomIDs()
        {
            ...
            RoomID.Add(new CorruptEnemyRoom11());
            RoomID.Add(new CorruptEnemyRoom11Up());
            RoomID.Add(new CorruptEnemyRoom12Down());
            RoomID.Add(new CorruptEnemyRoom12Up());
            RoomID.Add(new CrimsonEnemyRoom8());
            RoomID.Add(new CrimsonEnemyRoom9());
            RoomID.Add(new CrimsonEnemyRoom9Up());
            RoomID.Add(new DesertEnemyRoom9Up());
            RoomID.Add(new DesertEnemyRoom10());
            RoomID.Add(new DesertEnemyRoom10Down());
            ...
            RoomID.Add(new SanctuaryLobbyRoom1());
            RoomID.Add(new CorruptEnemyRoom13());
            RoomID.Add(new CrimsonEnemyRoom10());
            RoomID.Add(new CrimsonEnemyRoom10Down());
            RoomID.Add(new DesertEnemyRoom11Down());
            RoomID.Add(new DesertEnemyRoom11Up());
            RoomID.Add(new DungeonEnemyRoom7());
            RoomID.Add(new DungeonEnemyRoom7Up());
            RoomID.Add(new ForestEnemyRoom9());
            RoomID.Add(new HellEnemyRoom12());
            RoomID.Add(new JungleEnemyRoom6());
            RoomID.Add(new SnowEnemyRoom11());
            RoomID.Add(new TempleEnemyRoom9Down());
            RoomID.Add(new TempleEnemyRoom9Up());
            RoomID.Add(new BaseEnemyRoom10());
            RoomID.Add(new DesertEnemyRoom12());
            RoomID.Add(new DungeonEnemyRoom8());
            RoomID.Add(new DungeonEnemyRoom8Down());
            RoomID.Add(new SnowEnemyRoom12Up());
            RoomID.Add(new CorruptEnemyRoom14());
            RoomID.Add(new JungleEnemyRoom7());
            RoomID.Add(new JungleEnemyRoom7Up());
