...
{
    public class TempleEnemyRoom8Up : Room
    {
        public override int AssociatedFloor => FloorDict["Temple"];
        public override string Key => "TempleEnemyRoom8Up";
        public override string Filename => "Schematics/RoomSchematics/TempleEnemyRoom8Up.csch";
