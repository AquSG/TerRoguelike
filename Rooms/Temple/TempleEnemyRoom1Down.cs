...
{
    public class TempleEnemyRoom1Down : Room
    {
        public override int AssociatedFloor => FloorDict["Temple"];
        public override string Key => "TempleEnemyRoom1Down";
        public override string Filename => "Schematics/RoomSchematics/TempleEnemyRoom1Down.csch";
