...
{
    public class TempleEnemyRoom8 : Room
    {
        public override int AssociatedFloor => FloorDict["Temple"];
        public override string Key => "TempleEnemyRoom8";
        public override string Filename => "Schematics/RoomSchematics/TempleEnemyRoom8.csch";
