...
{
    public class DungeonEnemyRoom1 : Room
    {
        public override int AssociatedFloor => FloorDict["Dungeon"];
        public override string Key => "DungeonEnemyRoom1";
        public override string Filename => "Schematics/RoomSchematics/DungeonEnemyRoom1.csch";
        ...
        public override void InitializeRoom()
        {
            ...
            AddRoomNPC(MakeEnemySpawnPos(Left, 8, -1), ChooseEnemy(AssociatedFloor, 0), 60, 120, 0.45f, 1);
            AddRoomNPC(MakeEnemySpawnPos(Left, 6, 9), ChooseEnemy(AssociatedFloor, 0), 60, 120, 0.45f, 1);
