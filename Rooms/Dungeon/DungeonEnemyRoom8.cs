...
{
    public class DungeonEnemyRoom8 : Room
    {
        public override int AssociatedFloor => FloorDict["Dungeon"];
        public override string Key => "DungeonEnemyRoom8";
        public override string Filename => "Schematics/RoomSchematics/DungeonEnemyRoom8.csch";
        ...
        public override void InitializeRoom()
        {
            ...
            AddRoomNPC(MakeEnemySpawnPos(Top, -11, 7), ChooseEnemy(AssociatedFloor, 1), 240, 120, 0.45f, 0);
        }
    }
}
