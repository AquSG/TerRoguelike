...
{
    public class HellEnemyRoom5 : Room
    {
        public override int AssociatedFloor => FloorDict["Hell"];
        public override string Key => "HellEnemyRoom5";
        public override string Filename => "Schematics/RoomSchematics/HellEnemyRoom5.csch";
        public override bool CanExitRight => true;
        public override void InitializeRoom()
        {
            base.InitializeRoom();
            AddRoomNPC(MakeEnemySpawnPos(Center, -9, 12), ChooseEnemy(AssociatedFloor, 1), 60, 120, 0.45f, 0);
