...
{
    public class JungleEnemyRoom2 : Room
    {
        public override int AssociatedFloor => FloorDict["Jungle"];
        public override string Key => "JungleEnemyRoom2";
        public override string Filename => "Schematics/RoomSchematics/JungleEnemyRoom2.csch";
        ...
        public override void InitializeRoom()
        {
            ...
            AddRoomNPC(MakeEnemySpawnPos(BottomLeft, 15, -9), ChooseEnemy(AssociatedFloor, 0), 60, 120, 0.45f, 0);
