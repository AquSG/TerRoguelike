...
{
    public class JungleEnemyRoom7Up : Room
    {
        public override int AssociatedFloor => FloorDict["Jungle"];
        public override string Key => "JungleEnemyRoom7Up";
        public override string Filename => "Schematics/RoomSchematics/JungleEnemyRoom7Up.csch";
        ...
        public override void InitializeRoom()
        {
            ...
            AddRoomNPC(MakeEnemySpawnPos(Bottom, 9, -19), ChooseEnemy(AssociatedFloor, 1), 60, 120, 0.45f, 0);
