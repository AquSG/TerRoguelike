...
{
    public class SnowEnemyRoom10Down : Room
    {
        public override int AssociatedFloor => FloorDict["Snow"];
        public override string Key => "SnowEnemyRoom10Down";
        public override string Filename => "Schematics/RoomSchematics/SnowEnemyRoom10Down.csch";
