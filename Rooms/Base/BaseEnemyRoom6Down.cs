...
{
    public class BaseEnemyRoom6Down : Room
    {
        public override int AssociatedFloor => FloorDict["Base"];
        public override string Key => "BaseEnemyRoom6Down";
        public override string Filename => "Schematics/RoomSchematics/BaseEnemyRoom6Down.csch";
        public override bool CanExitRight => true;
        public override bool CanExitDown => true;
        public override void InitializeRoom()
        {
            base.InitializeRoom();
            AddRoomNPC(PercentPosition(0.16f, 0.97f), ChooseEnemy(AssociatedFloor, 0), 60, 120, 0.45f);
            AddRoomNPC(PercentPosition(0.84f, 0.97f), ChooseEnemy(AssociatedFloor, 0), 60, 120, 0.45f);
