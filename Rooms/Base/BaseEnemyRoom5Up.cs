...
namespace TerRoguelike.Rooms
{
    public class BaseEnemyRoom5Up : Room
    {
        ...
        {
            base.InitializeRoom();
            AddRoomNPC(PercentPosition(0.33f, 0.10f), ChooseEnemy(AssociatedFloor, 2), 60, 120, 0.45f);
            AddRoomNPC(PercentPosition(0.66f, 0.10f), ChooseEnemy(AssociatedFloor, 2), 60, 120, 0.45f);
