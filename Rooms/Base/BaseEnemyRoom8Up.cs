...
{
    public class BaseEnemyRoom8Up : Room
    {
        public override int AssociatedFloor => FloorDict["Base"];
        public override string Key => "BaseEnemyRoom8Up";
        public override string Filename => "Schematics/RoomSchematics/BaseEnemyRoom8Up.csch";
