...
{
    public class ForestEnemyRoom7 : Room
    {
        public override int AssociatedFloor => FloorDict["Forest"];
        public override string Key => "ForestEnemyRoom7";
        public override string Filename => "Schematics/RoomSchematics/ForestEnemyRoom7.csch";
